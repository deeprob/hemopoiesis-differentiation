...
cat ${1%%.bigBed}".bed" | awk -F '\t' -v OFS='\t' '{print $1, $2, $3, $1"_"$2"_"$3}' > ${1%%.bigBed}"master_peak_list.withpkname.bed"


bigWigAverageOverBed ${1%%.bigBed}".bw" ${1%%.bigBed}"master_peak_list.withpkname.bed" ${1%%.bigBed}"master_peak_list.bigbedfile1.tab"
